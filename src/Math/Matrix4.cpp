#include "PhEngine/Math/Matrix4.h"
...
PhEngine::Math::Matrix4 operator+(const PhEngine::Math::Matrix4& firstMatrix, const PhEngine::Math::Matrix4& secondMatrix) noexcept
{
    PhEngine::Math::Matrix4 matrix(firstMatrix);
...
PhEngine::Math::Matrix4 operator*(const PhEngine::Math::Matrix4& matrix, const float scalar) noexcept
{
    PhEngine::Math::Matrix4 mat(matrix);
    mat.Multiply(scalar);
    return mat;
}
...
bool operator==(const PhEngine::Math::Matrix4& firstMatrix, const PhEngine::Math::Matrix4& secondMatrix) noexcept
{
...
std::ostream& operator<<(std::ostream& cout, const PhEngine::Math::Matrix4& matrix)
{
