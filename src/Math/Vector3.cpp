...
{
    return PhEngine::Math::Vector3(firstVector.X + secondVector.X, firstVector.Y + secondVector.Y, firstVector.Z + secondVector.Z);
}
...
{
    return PhEngine::Math::Vector3(vector.X * scalar, vector.Y * scalar, vector.Z * scalar);
}
