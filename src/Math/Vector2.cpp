...
PhEngine::Math::Vector2 operator+(const PhEngine::Math::Vector2& firstVector, const PhEngine::Math::Vector2& secondVector) noexcept
{
    return PhEngine::Math::Vector2(firstVector.X + secondVector.X, firstVector.Y + secondVector.Y);
}
...
PhEngine::Math::Vector2 operator*(const PhEngine::Math::Vector2& vector, const float scalar) noexcept
{
    return PhEngine::Math::Vector2(vector.X * scalar, vector.Y * scalar);
}
...
PhEngine::Math::Vector2 operator/(const PhEngine::Math::Vector2& vector, const float scalar)
{
    if (scalar == 0)
    {
...
PhEngine::Math::Vector2 operator/(const PhEngine::Math::Vector2& firstVector, const PhEngine::Math::Vector2& secondVector)
{
...
bool operator==(const PhEngine::Math::Vector2& firstVector, const PhEngine::Math::Vector2& secondVector) noexcept
{
...
std::ostream& operator<<(std::ostream& os, const PhEngine::Math::Vector2& vector) noexcept
{
